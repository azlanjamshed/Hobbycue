...
import logo from "/153cf988785cdcec05510cbdc9cb1b82a17b77fc.png";
...
const Navbar = () => {
  return (
    <div className="w-full h-[80px] flex justify-between  sm:justify-evenly items-center px-5  py-5 border-l-0 border-gray-300 ">
      <div className=" w-[156.4px] h-[32px] sm:w-[293.26px] sm:h-[60px]">
        <img src={logo} alt="" />
      </div>

      <div className=" items-center justify-between  border rounded-2xl w-[400px] h-[50px] hidden sm:flex">
        <input
          type="text"
        ...
        <div className="w-[60px] h-[50px] flex items-center justify-center rounded-r-2xl   bg-[#8165a2] ">
      ...
      <div className=" hidden sm:flex items-center gap-8 ">
        <div className=" flex items-center gap-2">
          ...
          >
            <path
              d="M11.9999 14.071L8.17891 10.25C7.76491 9.83601 7.09291 9.83601 6.67891 10.25C6.26491 10.664 6.26491 11.336 6.67891 11.75L11.2929 16.364C11.6839 16.755 12.3169 16.755 12.7069 16.364L17.3209 11.75C17.7349 11.336 17.7349 10.664 17.3209 10.25C16.9069 9.83601 16.2349 9.83601 15.8209 10.25L11.9999 14.071Z"
              fill="#939CA3"
            />
          </svg>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <p className="text-[20px]">Hobbies</p>
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        <div>
          <FaBookmark className="text-[#8165a2] w-[24px] h-[24px]" />
        </div>

        <div>
          <FaBell className="text-[#8165a2] w-[24px] h-[24px]" />
        </div>
        <div>
          <FaShoppingCart className="text-[#8165a2] w-[24px] h-[24px]" />
        </div>
        <button className="flex items-center justify-center border-2 border-[#8165a2] w-[112px] h-[40px] rounded-xl px-4 py-1 cursor-pointer">
          <p className="text-[#8165a2] font-semibold text-[20px]">Sign In</p>
        </button>
      </div>
      <div className="flex sm:hidden gap-4">
        <div>
          {" "}
          <IoMdSearch className="text-[#8165a2] w-[24px] h-[24px]" />
        </div>
        ...
        <div>
          {" "}
          <IoMenu className="text-[#8165a2] w-[24px] h-[24px]" />
        </div>
      </div>
    </div>
  );
